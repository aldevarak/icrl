...
<body>
<form method="post" id="frm_agr_transporte" name="frm_agr_transporte">
<div class="modal-body">
      <div class="form-group col-xs-6">
        <label for="nb_clientes">Nombre del transporte</label>
        <input type="text" class="form-control" id="nb_transporte" name="nb_transporte" placeholder="Nombre" value="" required>
      </div>
      <div class="form-group col-xs-6">
        <label for="nu_telefono">Teléfonos:</label>
        <input type="text" class="form-control" id="nu_telefono" name="nu_telefono" placeholder="0212-5896956" value="" required>
      </div>
...
$('#frm_agr_transporte').on('init.field.fv', function(e, data) {
		...
		fields: {
			...
			$('#frm_agr_transporte').submit(function(event) {
				var formData = {
				...
				$.ajax({
					...
					url         : 'fichas/editores/fun_agregar_transporte.php', // the url where we want to POST
