...
<div class="modal-body">
    <div class="form-group col-xs-12">
      ...
      <input type="text" class="form-control" id="nb_categoria" name="nb_categoria" value="<?php echo $cod['nb_categoria'];?>" required>
		...
		fields: {
			...
			$('#frm_agregar_categoria').submit(function(event) {
				...
				$.ajax({
					...
					url         : 'fichas/editores/fun_editar_categoria.php', // the url where we want to POST
