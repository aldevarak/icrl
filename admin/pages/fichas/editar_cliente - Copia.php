...
if (isset($_POST['btn_enviar'])){
	...
	//echo $sql;
	echo "<script type='text/javascript' charset='utf-8'>parent.$('#modal_editar_iframe').modal('hide');parent.parent.parent.location.href='../pages/index.php';parent.parent.parent.cambio('fichas/clientes.php','cont');</script>";	
}
?>
<!doctype html>
<html>
...
<body>
<form method="post" id="frm_editar" name="frm_editar" action="editar_cliente.php">
