...
<body>
<form method="post" id="frm_editar_division" name="frm_editar_division">
...
$('#frm_editar_division').formValidation({
		framework: 'bootstrap',
		excluded: ':disabled',
		icon: {
		...
		fields: {
			...
			$('#frm_editar_division').submit(function(event) {
				var formData = {
				...
				$.ajax({
					...
					url         : 'fichas/editores/fun_editar_division.php', // the url where we want to POST
