...
$result = mysqli_query($link,"SELECT * FROM tg011_division2 WHERE co_division2='".$id."'");
...
<body>
<form method="post" id="frm_editar_division2" name="frm_editar_division2">
<div class="modal-body">
    ...
    <label for="">División</label>
      ...
      <?php
	  	$sql10="SELECT div1.*,slin.nb_sublineas FROM (tg010_division AS div1 INNER JOIN tg009_sublineas AS slin ON div1.co_sublineas=slin.co_sublineas) WHERE div1.in_estatus='1' ORDER BY div1.nb_division";
    ...
    <div class="form-group col-xs-12">
      ...
      <input type="text" class="form-control" id="nb_division2" name="nb_division2" value="<?php echo $cod['nb_division2'];?>" required>
...
$('#frm_editar_division2').formValidation({
		framework: 'bootstrap',
		excluded: ':disabled',
		icon: {
		...
		fields: {
			...
			$('#frm_editar_division2').submit(function(event) {
				var formData = {
				...
				$.ajax({
					...
					url         : 'fichas/editores/fun_editar_division2.php', // the url where we want to POST
