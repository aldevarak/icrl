...
if ($_SESSION['co_usuario']!='1'){	
	header("refresh: 0; url=http://".$_SERVER['HTTP_HOST']."/bydigitalv3.1/menu");
}
...
<link rel="stylesheet" type="text/css" href="../../css/editor/wysiwyg-editor.css">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="menu-usuario">
		<div class="" role="group" aria-label="Menu del Usuario">
          ...
          <i class="fa fa-archive fa-2x"></i> <h5>Pedidos</h5>
          </button>
          ...
          <i class="fa fa-sitemap fa-2x"></i> <h5>Transporte</h5>
          </button>
          ...
          <button type="button" class="btn btn-default navbar-btn" href="javaScript:;" onclick="cambio('fichas/estadisticas.php?sw=0','cont');">
...
<nav class="navbar navbar-default navbar-fixed-bottom"><!--BOTONERA DE BYDIGITAL-->
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand"><i class="fa fa-shopping-cart"></i> Bydigital 3.5</a>
    </div>
...
<div class="modal fade" id="modal_det_iframe" tabindex="-1" role="dialog" aria-labelledby="modal_det_iframe">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <iframe id="ventana" width="100%" frameborder="0"></iframe>
    </div>
  </div>
</div>
...
<script src="../../js/editor/wysiwyg-editor.js"></script>
<script src="../js/xcharts/d3.v3.min.js"></script>
<script src="../js/xcharts/xcharts.min.js"></script>
...
$('#modal_det_iframe').on('show.bs.modal', function (event) {
	...
	modal.find('#ventana').height(height)
	//alert(height);
})
