...
<div class="row">
    ...
    <div>
		...
		while ($row5=mysqli_fetch_array($res5)) {
			...
			<tr>
                ...
                <td class='text-right'>Bs.F ".number_format($precio,2,",",".")."</td>
                <td class='text-right'>Bs.F ".number_format($row5['nu_sub_total'],2,",",".")."</td>
            </tr>
			";	
    ...
    <div class="row text-right">
        ...
        <div class="col-xs-2">
            <strong>
                Bs.F <?php echo number_format($sub_total,2,",",".");?><br>
                Bs.F <?php echo number_format($iva,2,",",".");?><br>
                Bs.F <?php echo number_format($cod['nu_total'],2,",",".");?>
            </strong>
        </div>
    </div>
    <hr>
