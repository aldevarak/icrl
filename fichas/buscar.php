...
if (isset($_GET['bus'])){ $bus = $_GET['bus'];}
//echo $bus;
?>
<!doctype html>
<html>
...
<div id="paginar">
    ...
    $sql_des="SELECT * FROM tg013_productos WHERE (nb_productos LIKE '%".$bus."%' OR tx_descripcion LIKE '%".$bus."%') AND in_estatus='1' ".$sql_stock."";
	//echo $sql_des;
	$resultados_des = mysqli_query($link,$sql_des);
	//echo $sql_des;
	
	if (mysqli_num_rows($resultados_des)>0) {
