			...
			while ($div1 = mysqli_fetch_array($res131)) {//while
				...
				$estructura_div2.=$div2['co_division2']." - ".$div2['nb_division2']."<br>";
					...
					$estructura_div3.=$div3['co_division3']." - ".$div3['nb_division3']."<br>";
						...
						$sql12="DELETE FROM tg012_division3 WHERE co_division3='".$div3['co_division3']."'";
						mysqli_query($link,$sql12);
						//echo $sql12."<br>";
						$eliminar_div3.=$sql12.";<br>";

					}
					$sql12="DELETE FROM tg011_division2 WHERE co_division2='".$div2['co_division2']."'";
					mysqli_query($link,$sql12);
					//$estructura_div3.="<br>";
					//echo $sql12."<br>";
					$eliminar_div2.=$sql12.";<br>";
				}
				//$estructura_div2.="<br>";
				$sql12="DELETE FROM tg010_division WHERE co_division='".$div1['co_division']."'";
				mysqli_query($link,$sql12);
				//echo $sql12."<br>";
				$eliminar_div.=$sql12.";<br>";
			}
			//$estructura_div1.="<br>";
			$sql12="DELETE FROM tg009_sublineas WHERE co_sublineas='".$slinea['co_sublineas']."'";
			mysqli_query($link,$sql12);
			//echo $sql12."<br>";
			$eliminar_slin.=$sql12.";<br>";
		}
		//$estructura_slin.="<br>";
		$sql12="DELETE FROM tg008_linea WHERE co_linea='".$linea_rep['co_linea']."'";
		mysqli_query($link,$sql12);
		//echo $sql12."<br>";
		$eliminar_lin.=$sql12.";<br>";
...
echo $eliminar_div3."<br>";
echo $eliminar_div2."<br>";
echo $eliminar_div."<br>";
echo $eliminar_slin."<br>";
echo $eliminar_lin."<br>";
