...
<form method="post" id="frm_pago" name="frm_pago" action="../fichas/procesar-pago.php">
	<div class='form-group col-xs-12'>
	  ...
	  <div class='form-group col-xs-6'>
			<label><input type="radio" name="pago" value="pago_t" id="pagotot"  checked> Pago total</label>
			<input type='text' class='form-control' id='pagototal' name="pagototal" placeholder="Pago total" value="<?php echo $deuda;?>" readonly>
	  </div>
	  <div class='form-group col-xs-6'>
			<label><input type="radio" name="pago" id="pagopar" value="pago_p"> Pago parcial</label>
		...
		fields: {
			...
			$('#frm_pago').submit(function(event) {
				...
				var formData = {
					...
					'pagotchec'	: document.getElementById("pagotot").checked,
					'pagopchec'	: document.getElementById("pagopar").checked,
				...
				$.ajax({
					...
					url         : '../fichas/editores/fun_noti_pago.php', // the url where we want to POST
