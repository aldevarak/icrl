...
(b=jQuery.fn.jplist.dal.services.CookiesService.restoreCookies(a.options.storageName)),"localstorage"===a.options.storage&&jQuery.fn.jplist.dal.services.LocalStorageService.supported()&&(b=jQuery.fn.jplist.dal.services.LocalStorageService.restore(a.options.storageName)),0<b.length){for(var c=[],d=0;d<b.length;d++)b[d].inStorage&&c.push(b[d]);0<c.length&&(a.controls.setStatuses(c,!0),a.observer.trigger(a.observer.events.knownStatusesChanged,[c]))}else e(a,!0);else e(a,!0)},e=function(a,c){var e;e=
a.controls.getStatuses(c);a.observer.trigger(a.observer.events.knownStatusesChanged,[e]);b(a)},h=function(a){var b;b=[];b=a.$root.find(a.options.panelPath).find("[data-control-type]");a.controls=new jQuery.fn.jplist.ui.panel.collections.ControlsCollection(a.options,a.observer,a.history,a.$root,b);a.paths=a.controls.getPaths();jQuery.fn.jplist.logEnabled(a.options)&&(b=jQuery.map(a.paths,function(a,b){return a&&a.jqPath?a.jqPath:""}),jQuery.fn.jplist.info(a.options,"Panel paths: ",b.join(", ")))},
f=function(c){c.observer.on(c.observer.events.init,function(b){if(c.options.deepLinking){jQuery.fn.jplist.info(c.options,"Deep linking enabled","");var e=window.decodeURIComponent(jQuery.trim(window.location.hash.replace("#","")));b=[];var d,f=[],g;if(c.options.deepLinking&&""!==jQuery.trim(e)){b=e.split(c.options.delimiter1);for(e=0;e<b.length;e++)d=b[e],g=d.split("="),2===g.length&&(d=g[0],g=g[1],d=d.split(c.options.delimiter0),2===d.length&&(d={controlName:d[0],propName:d[1],propValue:g},f.push(d)))}jQuery.fn.jplist.info(c.options,
...
[d,k,a])};a.prototype.setStatuses=function(a,b){for(var c,d,k=0;k<a.length;k++){c=a[k];d=c.name;for(var l=c.action,m=[],n=void 0,q=0;q<this.controls.length;q++)n=this.controls[q],n.name===d&&n.action===l&&m.push(n);d=m;for(l=0;l<d.length;l++)jQuery.isFunction(d[l].setStatus)&&d[l].setStatus(c,b)}};a.prototype.getDeepLinksUrl=function(){var a;a="";for(var b=[],c="",d=0;d<this.controls.length;d++)a=this.controls[d],jQuery.isFunction(a.getDeepLink)&&(c=jQuery.trim(a.getDeepLink())),""!==c&&-1===jQuery.inArray(c,
