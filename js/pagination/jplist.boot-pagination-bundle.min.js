...
a.action,a.type,b,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},g=function(a){a.$control.on("click","li",function(){var c,b=null;c=Number(jQuery(this).attr("data-number"))||0;b=e(a,!1);b.data.currentPage=c;a.history.addStatus(b);a.observer.trigger(a.observer.events.statusChanged,[b])})},f=function(a){a.params={view:new jQuery.fn.jplist.ui.controls.BootstrapPaginationView(a.$control,a.controlOptions)};g(a);return jQuery.extend(this,a)};f.prototype.getStatus=function(a){return e(this,
a)};f.prototype.getDeepLink=function(){var a="",c;this.inDeepLinking&&(c=e(this,!1),c.data&&(jQuery.isNumeric(c.data.currentPage)&&(a=this.name+this.options.delimiter0+"currentPage="+c.data.currentPage),jQuery.isNumeric(c.data.number)&&(a=this.name+this.options.delimiter0+"number="+c.data.number)));return a};f.prototype.getStatusByDeepLink=function(a,c){var b;a:if(b=null,this.inDeepLinking){if("currentPage"!==a){b=null;break a}b=e(this,!0);b.data&&"currentPage"===a&&(b.data.currentPage=c)}return b};
f.prototype.setStatus=function(a,c){a.data&&a.data.paging&&this.params.view.build(a.data.paging)};jQuery.fn.jplist.ui.controls.BootstrapPagination=function(a){return new f(a)};jQuery.fn.jplist.controlTypes["boot-pagination"]={className:"BootstrapPagination",options:{range:7,jumpToStart:!1,prevArrow:"&lsaquo;",nextArrow:"&rsaquo;",firstArrow:"&laquo;",lastArrow:"&raquo;"}}})();(function(){var e=function(a,c,b,d){var e="";a.$control.find('[data-type="page"]').remove();for(var f=c;f<b;f++)e+='<li data-type="page" ',f===d&&(e+=' class="jplist-current active" data-active="true" '),c=f+1,e+=' data-number="'+f+'" ',e+='><a href="#">'+c+"</a></li>";a.$jplistPrev.after(e)},g=function(a){a.$control.on("click","a",function(c){c.preventDefault()})},f=function(a,c){var b={$control:a,options:c,$jplistFirst:null,$jplistPrev:null,$jplistNext:null,$jplistLast:null,mode:a.attr("data-mode")},
...
(this.$jplistFirst.removeClass("disabled"),this.$jplistPrev.removeClass("disabled"));a.currentPage==a.pagesNumber-1?(this.$jplistNext.addClass("disabled"),this.$jplistLast.addClass("disabled")):(this.$jplistNext.removeClass("disabled"),this.$jplistLast.removeClass("disabled"))};jQuery.fn.jplist.ui.controls.BootstrapPaginationView=function(a,c){return new f(a,c)}})();(function(){jQuery.fn.jplist.ui.controls.BootstrapPaginationDTO=function(e,g){var f={currentPage:e,paging:null};g&&(f.number=g);return f}})();(function(){var e=function(c){var a;a=c.params.$buttons.filter('[data-default="true"]').eq(0);0>=a.length&&(a=c.params.$buttons.eq(0));return a},g=function(a,b){var d=null,d=b?e(a):a.params.$buttons.filter('[data-jplist-selected="true"]'),d=new jQuery.fn.jplist.ui.controls.BootstrapDropdownPaginationDTO(d.attr("data-number"));return d=new jQuery.fn.jplist.app.dto.StatusDTO(a.name,a.action,a.type,d,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},f=function(a){a.params.$buttons.on("click",
function(b){var d;b.preventDefault();d=g(a,!1);if(b=jQuery(this).attr("data-number"))d.data.number=b;a.history.addStatus(d);a.observer.trigger(a.observer.events.statusChanged,[d])})},a=function(a){a.params={$textBox:a.$control.find('[data-type="selected-text"]'),$buttons:a.$control.find("[data-number]")};f(a);return jQuery.extend(this,a)};a.prototype.getStatus=function(a){return g(this,a)};a.prototype.getDeepLink=function(){var a="",b;this.inDeepLinking&&(b=g(this,!1),b.data&&(jQuery.isNumeric(b.data.number)||
"all"===b.data.number)&&(a=this.name+this.options.delimiter0+"number="+b.data.number));return a};a.prototype.getStatusByDeepLink=function(a,b){var d;a:if(d=null,this.inDeepLinking){if("number"!==a&&a!=="path"+this.options.delimiter2+"type"+this.options.delimiter2+"order"&&"path"!==a){d=null;break a}d=g(this,!0);d.data&&"number"===a&&jQuery.isNumeric(d.data.number)&&(d.data.number=b)}return d};a.prototype.setStatus=function(a,b){var d=null;this.params.$buttons.attr("data-jplist-selected",!1);d="default"==
a.data.path?e(this):"all"===a.data.number?this.params.$buttons.filter('[data-number="all"]'):this.params.$buttons.filter('[data-number="'+a.data.number+'"]');0<d.length&&(d.attr("data-jplist-selected",!0),this.params.$textBox.text(d.text()))};jQuery.fn.jplist.ui.controls.BootstrapItemsPerPageDropdown=function(c){return new a(c)};jQuery.fn.jplist.controlTypes["boot-items-per-page-dropdown"]={className:"BootstrapItemsPerPageDropdown",options:{},dropdown:!0}})();(function(){jQuery.fn.jplist.ui.controls.BootstrapDropdownPaginationDTO=function(e){return{number:e}}})();