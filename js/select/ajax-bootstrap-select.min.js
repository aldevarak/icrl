 ...
 */
a.fn.ajaxSelectPicker.locale["en-US"]={currentlySelected:"Seleccionado",emptyTitle:"Seleccione o escriba",errorText:"Unable to retrieve results",searchPlaceholder:"Buscar...",statusInitialized:"Comience a escribir para su busqueda",statusNoResults:"No hay resultados <button type='' class='btn btn-info btn-sm' id='btn_new_d' name='btn_new_d' title='Otro Médico'>Agregar Nuevo</button>",statusSearching:"Buscando..."},a.fn.ajaxSelectPicker.locale.en=a.fn.ajaxSelectPicker.locale["en-US"]}(jQuery,window);