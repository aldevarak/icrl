...
$estructura_div.="
		...
		<li id='ref_division2'><a class='btn-cambio' href='../fichas/division2.php?id=".$cod5['co_division2']."' onclick=\"menu_nav4(".$cod['co_categoria'].",".$cod2['co_linea'].",".$cod3['co_sublineas'].",".$cod4['co_division'].",".$cod5['co_division2'].");close_menu();\">".$cod5['nb_division2']."</a></li>";
