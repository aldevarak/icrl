...
$dir="http://".$_SERVER['HTTP_HOST']."/icrl/menu";
?>
<!doctype html>
<html>
<head>
				...
				<ul class="cd-dropdown-content">
					...
					while ($categorias = mysqli_fetch_array($resultados_cate)) {
						...
						<a>".$categorias['nb_categoria']."</a>
							<ul class='cd-secondary-dropdown is-hidden' style='height: 300px;width: 800px;border: 1px solid #ddd;background: #f1f1f1;overflow-y: scroll;'>
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        <a class="btn btn-default btn-cambio" type="button" onclick="x=document.getElementById('tx_buscador').value;x=x.replace(/\s/g,'_');cambio('../fichas/buscar.php?bus='+x,'cont');" id="btn_buscar" name="btn_buscar"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                         ...
                         <div class="btn-group hidden-xs" role="group" aria-label="..." id="divbusavanzada">
                         <a  class='btn btn-xs btn-default btn-cambio' href='../fichas/busqueda.php' nameid="busavanzada" id="busavanzada">Búsqueda Avanzada</a>
                         </div>
                      </span>
                    </div>
                </div>
    	...
    	<div class="row">
    		<div class="col-lg-12 col-md-12 hidden-xs hidden-sm" id="breadcrumbs">
                <ol class="breadcrumb" id="ol_bread" style="background-color: #e01a08;">
                  <li><a href="javaScript:;" onclick="location.href='<?php echo $dir;?>';">Inicio</a></li>
...
function no_busqueda() {
	BootstrapDialog.show({
	title: 'Registro sin exito',
	type: BootstrapDialog.TYPE_DANGER,
	message: 'No se puedo conseguir un producto con sus selecciones',
	buttons: [{
		  label: 'OK',
		  action: function(dialogItself){
			  dialogItself.close();
			  cambio('../fichas/busqueda.php','cont');
			  //location.reload();
			  }
	  }]
	});
