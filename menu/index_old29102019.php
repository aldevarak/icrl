...
<div id="page-loader"><span class="preloader-interior"></span></div>
        <nav class="navbar navbar-dark bg-success navbar-static-top" role="navigation">
     ...
     <nav class="navbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle menu-inicio" id="iniciodesesion" data-toggle="dropdown"><?php
        ...
        <li class="dropdown">
        	<a id="tx_carrito" name="tx_carrito" class="dropdown-toggle btn-cambio menu-inicio" aria-expanded="false" href="../fichas/carrito-total.php"><i class="fa fa-shopping-cart"></i> <?php echo $cantidad_carrito;?> productos / <?php echo $total;?><?php echo $_SESSION['moneda']['di_simbolo'];?></a>
        </li>
			  <?php
          ...
          <div class="navbar navbar-dark navbar-static-top">
			...
			<nav class="cd-dropdown">
				...
				<ul class="cd-dropdown-content">
                    ...
                    <?php
					$sql_cate="SELECT * FROM tg007_categoria WHERE in_estatus='1' ORDER BY nb_categoria";
					...
					while ($categorias = mysqli_fetch_array($resultados_cate)) {
						...
						$sql_lineas="SELECT * FROM tg008_linea WHERE co_categoria='".$categorias['co_categoria']."' AND in_estatus='1'";
						...
						while ($lineas = mysqli_fetch_array($resultados_lineas)) {	
							...
							$sql_sublineas="SELECT * FROM tg009_sublineas WHERE co_linea='".$lineas['co_linea']."' AND in_estatus='1'";
							...
							while ($sublineas = mysqli_fetch_array($resultados_sublineas)) {	
								...
								$sql_division="SELECT * FROM tg010_division WHERE co_sublineas='".$sublineas['co_sublineas']."' AND in_estatus='1'";
								...
								while ($division = mysqli_fetch_array($resultados_division)) {
									...
									$sql_division2="SELECT * FROM tg011_division2 WHERE co_division='".$division['co_division']."' AND in_estatus='1'";
									...
									while ($division2 = mysqli_fetch_array($resultados_division2)) {
										...
										$sql_division3="SELECT * FROM tg012_division3 WHERE co_division2='".$division2['co_division2']."' AND in_estatus='1'";
	...
	<div class="container-fluid">
    	<div class="row">
    		<div class="col-lg-12 col-md-12 hidden-xs hidden-sm" id="breadcrumbs">
                <ol class="breadcrumb" id="ol_bread">
                  <li><a href="javaScript:;" onclick="window.location='../index.php';">Inicio</a></li>
  ...
  <div class="container">
      <div class="row">
      	<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <p class=" pull-left"><?php echo $_SESSION['params']['tx_nombre_empresa']." - ".$_SESSION['params']['tx_rif']." - ".$_SESSION['params']['tx_pie'];?>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" id="contactosinferiores">
            <address class=" pull-left"><abbr title="Phone / Teléfono">Telf:</abbr> <?php echo $_SESSION['params']['tx_telefono'];?><!--<abbr title="Email"> Email:</abbr> <?php //echo $_SESSION['params']['tx_mail'];?></address>--></p>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
...
function registro_no_exito() {
	...
	message: 'No se puedo realizar su registro, es Posible que ya Exista el Usuario',
	buttons: [{
		  label: 'OK',
		  action: function(dialogItself){
			  dialogItself.close();
